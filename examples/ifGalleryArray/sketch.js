...
//changing the image function to (imageArray[currentImage]) allows us to do the same thing as the if else if statements with less code
...
*/
  ...
  image(imageArray[currentImage], 0, 0, imageArray[currentImage].width / 2, imageArray[currentImage].height / 2);
}
